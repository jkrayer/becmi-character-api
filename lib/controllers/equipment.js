...
// a -> Boolean
const contract = {
  isObject: R.pipe(R.type, R.equals('Object')),
  isString: R.pipe(R.type, R.equals('String')),
  isUndefined: R.pipe(R.type, R.equals('Undefined'))
};
...
const verifyQuery = R.allPass([
  contract.isObject,                        // the argument is an object
  R.pipe(getClassName, contract.isString),  // it has a 'name' attribute whose value is a string
